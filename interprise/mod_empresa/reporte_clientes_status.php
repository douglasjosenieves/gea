...
$status ='';
				...
				$resulv =  mysql_query("SELECT distinct(status) FROM empresa");
...
if (isset($_GET['status'])) {
	...
	$resul =  mysql_query("SELECT * FROM `empresa` where anulado <> 1 and status = '".$_GET['status']."'");
	# code...
}
...
$resul =  mysql_query("SELECT * FROM `empresa` where anulado <> 1");
