...
<div class="box rte">
 <h3 class="boxHeadlineSub">Datos laborales</h3>
<div class="row">
...
<div class="form-group">
<label for="basicInput"> <?php echo TITULO ?> (Nombre Fiscal)</label>
...
<input type="date" value="<?php echo $data['data'][0]['fecha_inicio'] ?>"  class="form-control" name="fecha_inicio" id="fecha_inicio" placeholder="Fecha de inicio:">
</div>
</div>
...
<input type="date" value="<?php echo $data['data'][0]['fecha_terminacion'] ?>"   class="form-control" name="fecha_terminacion" id="fecha_terminacion" placeholder="Fecha de Terminacion">
</div>
</div>
...
<select id="dependiente" required name="dependiente" class="js-select ">
