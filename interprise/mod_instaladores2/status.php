...
$status ='';
				...
				$resulv =  mysql_query("SELECT distinct(status) FROM instaladores");
...
<head>
	...
	<title>instaladores por status</title>
...
<body>
	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					<a href="#" title="#">instaladores por status</a>
				</h1>
				<ol class="breadcrumb">
...
if (isset($_GET['status'])) {
	...
	$resul =  mysql_query("SELECT * FROM `instaladores` where anulado <> 1 and status = '".$_GET['status']."'");
	# code...
}
					 ...
					 <!-- Button Extra small -->
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="reporte-instaladores-excel.php?id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="Exportar a excel"><i class="fa fa-file-excel-o"></i> Exportar a EXCEL</a></li>
							</ul>
						</div>
