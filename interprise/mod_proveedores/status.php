...
$status ='';
				...
				$resulv =  mysql_query("SELECT distinct(status) FROM proveedores");
...
<head>
	...
	<title>proveedores por status</title>
...
<body>
	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					<a href="#" title="#">proveedores por status</a>
				</h1>
				<ol class="breadcrumb">
...
if (isset($_GET['status'])) {
	...
	$resul =  mysql_query("SELECT * FROM `proveedores` where anulado <> 1 and status = '".$_GET['status']."'");
	# code...
}
...
$resul =  mysql_query("SELECT * FROM `proveedores` where anulado <> 1");
					 ...
					 <!-- Button Extra small -->
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="../mod_proveedores/index.php?tipo=editar&id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="#"><i class="fa fa-eye"></i> Gestionar</a></li>
							
						
								
								<li><a href="reporte-proveedores-excel.php?id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="Exportar a excel"><i class="fa fa-file-excel-o"></i> Exportar a EXCEL</a></li>
							</ul>
						</div>
