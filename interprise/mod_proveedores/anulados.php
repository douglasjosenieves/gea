		...
		<div class="pageContent extended">
			<div class="container">
				...
				<div class="box box-without-bottom-padding">
					...
					<h3 class="boxHeadlineSub">Contacto<span class="cargando"><i class='fa fa-circle-o-notch fa-spin'></i>Loading...</span></h3>
...
require_once '../status_funtion.php';
	                  ...
	                  require_once '../status_funtion.php';
					$i=0;
					$resul =  mysql_query("SELECT * FROM `proveedores` order by id desc ");
