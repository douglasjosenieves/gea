...
define('TITULO',"Facturación");  /*TITULO DEL LAS VISTAS */
define('TITULO2',"Factura"); /*TITULO DEL LAS VISTAS  DEL DOCUMENTO GENERADO*/
...
define('MODULO',"mod_facturacion"); /*PARA EL LINK DE LOS PROCESOS*/
...
define('TABLA1',"factura"); /*LLAMADA DE TABLA EN EL ENVIO DE INFORMACION A LA BASE DE DATOS*/
define('TABLA2',"factura_detalle"); /*LLAMADA DE TABLA EN EL ENVIO DE INFORMACION A LA BASE DE DATOS*/
